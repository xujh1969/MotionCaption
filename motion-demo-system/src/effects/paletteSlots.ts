...
const SLOT_MAP: ComponentSlotMap = {
  ...
  't3-05': { borderColor: 'accent', numColor: 'title', nameColor: 'body', descColor: 'body', cardBg: 'bg' },
  't3-06': { titleColor: 'title', itemColor: 'body', cardBg: 'bg' },
  ...
  't4-03': { kickerColor: 'accent', titleColor: 'title', textColor: 'body', cardBg: 'bg' },
  't4-04': { borderColor: 'border', plusColor: 'accent', textColor: 'body', cardBg: 'bg' },
  't4-05': { borderColor: 'border', textColor: 'body', cardBg: 'bg' },
  't4-06': { titleColor: 'title', subColor: 'body', cardBg: 'bg' },
  't4-07': { titleColor: 'title', descColor: 'body', cardBg: 'bg' },
  't4-08': { borderColor: 'border', titleColor: 'title', descColor: 'body', cardBg: 'bg' },
  't4-09': { borderColor: 'border', textColor: 'title', cardBg: 'bg' },
  ...
  't6-08': { activeBg: 'accent', passedColor: 'accent', titleColor: 'title', descColor: 'body' },
  ...
  't7-07': { borderColor: 'border', colorA: 'accent', colorB: 'accent2', labelColor: 'title', tickColor: 'label', boxBg: 'bg' },
  't7-08': { borderColor: 'border', lineColor: 'accent', tickColor: 'label', boxBg: 'bg' },
  't7-09': { borderColor: 'border', numColor: 'title', descColor: 'body', boxBg: 'bg' },
  't7-10': { borderColor: 'border', waveColor: 'accent', tickColor: 'label', boxBg: 'bg' },
  't7-11': { borderColor: 'border', strokeColor: 'accent', labelColor: 'title', boxBg: 'bg' },
};
